...
def tune_model(
    ...
    Args:
        ...
        model_output: Path to save best model
    ...
    try:
        ...
        logger.info("✅ Data loaded successfully for tuning")
    ...
    try:
        ...
        logger.error(f"❌ Best model training failed: {e}")
        raise
    ...
    try:
        ...
        logger.warning(f"⚠️ MLflow logging error: {e}")
